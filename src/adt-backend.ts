...
import { readInactiveInventory } from "./inactive-inventory.js"
...
import { usageReferences as requestUsageReferences } from "abap-adt-api/build/api/syntax.js"
...
export async function replaceSourceWithClient(
  ...
  try {
    ...
    if (
      ...
      throw new Error("SOURCE_FINGERPRINT_CONFLICT: active source changed since review")
    }
