...
const sourceHashDigest = helperCapabilityDigests[targetName]
...
/** The minimal replacement, with four lines of context, that turns `oldBody` into `newBody`. */
function replacement(oldBody, newBody) {
...
try {
  ...
  const plan = replacement(oldBody, newBody)
  assert.equal(
